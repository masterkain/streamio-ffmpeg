...
module FFMPEG
  ...
  describe Movie do
    ...
    describe "parsing" do
      ...
      describe "given an mp4 audio file" do
        before(:all) do
          @movie = Movie.new("#{fixture_path}/movies/raise_the_dead.m4a")
        end

        it "should know the title" do
          @movie.title.should == "Raise The Dead M4A"
        end

        it "should know the artist" do
          @movie.artist.should == "Vemoth"
        end

        it "should know the album" do
          @movie.album.should == "The Upcoming End"
        end

        it "should know the genre" do
          @movie.genre.should == "Black Metal"
        end

        it "should know the track" do
          @movie.number.should == "1"
        end

        it "should know the date" do
          @movie.date.should == "2008"
        end
